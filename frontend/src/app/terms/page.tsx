    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h1 className="mb-4 text-4xl font-bold text-foreground">服务条款</h1>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">2. 账户注册与使用</h2>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">3. 可接受使用政策</h2>
            <p className="mb-2 text-sm font-medium text-muted-foreground">在使用SecMind服务时，您同意不会：</p>
            <ul className="ml-4 list-disc list-inside space-y-2 text-sm text-muted-foreground">
              <li>违反任何适用的法律法规</li>
              <li>利用服务进行任何非法活动</li>
              <li>干扰或破坏服务的正常运行</li>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">4. 知识产权</h2>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">5. 付费服务</h2>
            <ul className="ml-4 list-disc list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">7. 终止</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">8. 适用法律与争议解决</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">9. 条款变更</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">10. 联系我们</h2>
