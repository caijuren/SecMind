    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h1 className="mb-4 text-4xl font-bold text-foreground">隐私政策</h1>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">2. 信息使用</h2>
            <p className="mb-3 text-sm leading-relaxed text-muted-foreground">我们收集的信息将用于以下目的：</p>
            <ul className="ml-4 list-disc list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">3. 信息保护</h2>
            <p className="mb-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">4. 信息共享</h2>
            <p className="mb-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            ...
            <p className="mb-3 text-sm leading-relaxed text-muted-foreground">您对您的个人信息享有以下权利：</p>
            <ul className="ml-4 list-disc list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">6. 数据保留</h2>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">7. 儿童隐私</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-xl font-semibold text-foreground">8. 联系我们</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
