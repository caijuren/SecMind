...
const solutions = [
  {
    ...
    riskBadge: { text: "风险 高", cls: "border-red-500/20 bg-red-500/10 text-red-400" },
  },
  {
    icon: Cpu,
    title: "科技企业",
    ...
    riskBadge: { text: "风险 中", cls: "border-amber-500/20 bg-amber-500/10 text-amber-400" },
  },
  {
    icon: ShieldCheck,
    title: "政府机构",
    ...
    riskBadge: { text: "风险 极高", cls: "border-red-500/30 bg-red-500/20 text-red-300" },
  },
  {
    icon: Stethoscope,
    title: "医疗健康",
    ...
    riskBadge: { text: "风险 中", cls: "border-teal-500/20 bg-teal-500/10 text-teal-400" },
  },
];
...
const colorMap: Record<string, { border: string; bg: string; icon: string; text: string; badge: string; glow: string }> = {
  ...
  teal: {
    ...
    icon: "text-teal-400",
    text: "text-teal-300",
    badge: "border-teal-500/20 bg-teal-500/10 text-teal-400",
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-violet-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-8 pt-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-400 tabular-nums">4</div>
                  <div className="text-xs text-zinc-500 mt-1">覆盖行业</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-400 tabular-nums">99%</div>
                  <div className="text-xs text-zinc-500 mt-1">告警降噪</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-400 tabular-nums">&lt;5min</div>
                  <div className="text-xs text-zinc-500 mt-1">调查启动</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="grid grid-cols-2 grid-rows-2 gap-3">
                {solutions.map((sol) => {
                  ...
                  return (
                    <div
                      key={sol.title}
                      className={`group rounded-2xl border border-white/6 bg-[#131316] p-5 shadow-[0_0_40px_rgba(0,0,0,0.3)] transition-[shadow,transform] duration-300 ${colors.glow} hover:-translate-y-0.5 cursor-pointer`}
                    >
                      ...
                      <p className="text-[11px] text-zinc-500 leading-relaxed line-clamp-2">{sol.description}</p>
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl" aria-hidden="true" />
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-violet-500/10 rounded-full blur-2xl" aria-hidden="true" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 bg-[#0c0c10]">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(59,130,246,0.05)_0%,transparent_60%)]" aria-hidden="true" />
            ...
            {solutions.map((sol, idx) => {
              ...
              return (
                <AnimateIn key={sol.title} delay={idx * 120}>
                  <div
                    className={`group relative rounded-2xl border border-white/6 bg-[#131316] p-6 sm:p-8 shadow-[0_10px_24px_rgba(0,0,0,0.2)] transition-[shadow,transform] duration-300 ${colors.glow} hover:-translate-y-0.5`}
                  >
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed mb-4">{sol.description}</p>

                    <div className="space-y-4">
                      <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4">
                        <div className="flex items-center gap-2 mb-3">
                          <AlertTriangle className="size-3.5 text-red-400" />
                          <span className="text-xs font-semibold text-red-300">核心挑战</span>
                        </div>
                      ...
                      <div className={`rounded-xl border ${colors.border} ${colors.bg.replace('/10', '/05')} p-4`}>
                        <div className="flex items-center gap-2 mb-3">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-950/80 via-zinc-900 to-violet-950/80" aria-hidden="true" />
        <div className="absolute inset-0 opacity-[0.03]" aria-hidden="true" style={{ backgroundImage: 'radial-gradient(circle at 25% 25%, rgba(59,130,246,0.5) 1px, transparent 1px), radial-gradient(circle at 75% 75%, rgba(139,92,246,0.5) 1px, transparent 1px)', backgroundSize: '50px 50px' }} />

        <div className="relative max-w-4xl mx-auto text-center px-4">
          <AnimateIn>
            <Badge className="border-blue-500/20 bg-blue-500/10 text-blue-400 mb-6">找到适合您的方案</Badge>
          </AnimateIn>
          <AnimateIn delay={100}>
          ...
          <AnimateIn delay={400}>
            <div className="mt-14 pt-10 border-t border-zinc-800 flex flex-wrap justify-center gap-x-12 gap-y-4">
              {[
                { value: "金融", label: "等保合规" },
