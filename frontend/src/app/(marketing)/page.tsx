  ...
  return (
    <>
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-950/80 via-zinc-900 to-violet-950/80" />
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at 25% 25%, rgba(59,130,246,0.5) 1px, transparent 1px), radial-gradient(circle at 75% 75%, rgba(139,92,246,0.5) 1px, transparent 1px)', backgroundSize: '50px 50px' }} />

        <div className="relative max-w-4xl mx-auto text-center px-4">
          <AnimateIn>
            <Badge className="border-blue-500/20 bg-blue-500/10 text-blue-400 mb-6">{t("landing.cta.badge")}</Badge>
          </AnimateIn>
          <AnimateIn delay={100}>
