...
export default function AuthLayout({
  ...
  return (
    ...
    <div className="flex min-h-screen bg-slate-50">
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between bg-gradient-to-br from-cyan-50 via-white to-teal-50">
        <div
        ...
        <div
          ...
          aria-hidden="true"
          style={{
            background: 'radial-gradient(ellipse 60% 50% at 70% 30%, rgba(6,182,212,0.12) 0%, transparent 70%)',
          }}
        />
        <div
          ...
          aria-hidden="true"
          style={{
            background: 'radial-gradient(ellipse 50% 60% at 30% 70%, rgba(20,184,166,0.10) 0%, transparent 70%)',
          }}
        />
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-cyan-500/8 rounded-full blur-3xl animate-[pulse_8s_ease-in-out_infinite]" aria-hidden="true" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-teal-500/6 rounded-full blur-3xl animate-[pulse_10s_ease-in-out_infinite_2s]" aria-hidden="true" />
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="rounded-xl border border-cyan-500/15 bg-cyan-500/[0.06] p-4">
                ...
                <div className="text-xs text-slate-500 mt-1">92% 研判准确率</div>
              </div>
              <div className="rounded-xl border border-amber-500/15 bg-amber-500/[0.06] p-4">
                ...
                <div className="text-xs text-slate-500 mt-1">AI自动构建攻击链</div>
              </div>
              <div className="rounded-xl border border-purple-500/15 bg-purple-500/[0.06] p-4">
                ...
                <div className="text-xs text-slate-500 mt-1">调查到执行闭环</div>
              </div>
              <div className="rounded-xl border border-teal-500/15 bg-teal-500/[0.06] p-4">
                ...
                <div className="text-xs text-slate-500 mt-1">AI持续学习进化</div>
              </div>
            </div>
          </div>
        </div>
