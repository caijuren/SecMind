...
import { Mail, Lock, Phone, ShieldCheck, CheckCircle2, ArrowLeft } from 'lucide-react'
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 py-8">
        ...
        <Link href="/login">
          <Button className="mt-2 bg-gradient-to-r from-cyan-500 to-teal-500 font-semibold text-[#020a1a] shadow-[0_0_20px_rgba(0,212,255,0.3)]">
            返回登录
          </Button>
        </Link>
      </div>
    ...
    <div className="space-y-5">
      ...
      {mode === 'phone' ? (
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <Label className="text-sm text-white/60">确认新密码</Label>
            <div className="relative">
              <Lock className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-white/25" />
              <Input
                type="password"
      ...
      <div className="relative flex items-center">
        ...
        <span className="px-3 text-xs text-white/25">SSO 登录</span>
        <div className="flex-1 border-t border-white/8" />
      </div>
      ...
      <div className="text-center">
        <Link
          href="/login"
          className="inline-flex items-center gap-1 text-sm text-white/30 transition-colors hover:text-cyan-400"
        >
