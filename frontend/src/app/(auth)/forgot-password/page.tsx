...
export default function ForgotPasswordPage() {
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 py-8 rounded-2xl border border-white/[0.06] bg-[#131316] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <Link href="/login">
          <Button className="mt-2 rounded-xl border border-blue-500/20 bg-gradient-to-r from-blue-600 to-violet-600 font-semibold text-white shadow-[0_10px_26px_rgba(59,130,246,0.30)] transition-all hover:shadow-[0_14px_32px_rgba(59,130,246,0.38)] hover:-translate-y-0.5">
            返回登录
          </Button>
        </Link>
      </div>
  ...
  return (
    <div className="space-y-5 rounded-2xl border border-white/[0.06] bg-[#131316] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
      ...
      {mode === 'phone' ? (
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label className="text-sm text-zinc-400">邮箱地址</Label>
            <div className="relative">
      ...
      <div className="relative flex items-center">
        ...
        <span className="px-3 text-xs text-zinc-500">SSO 登录</span>
        <div className="flex-1 border-t border-white/[0.06]" />
      </div>
      ...
      <div className="text-center">
        <Link
          href="/login"
          className="inline-flex items-center gap-1 text-sm text-zinc-500 transition-colors hover:text-blue-400"
        >
