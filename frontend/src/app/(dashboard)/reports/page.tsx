...
function GenerateReportDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg border-slate-200 bg-white text-slate-700 shadow-lg">
        <DialogHeader>
          <DialogTitle className="text-slate-900">生成报告</DialogTitle>
        ...
        <div className="space-y-5 py-2">
          <div className="space-y-2">
            ...
            <Select value={reportType} onValueChange={(v) => v && setReportType(v)}>
                <SelectTrigger className="h-9 border-slate-200 bg-white text-sm text-slate-700 focus:ring-cyan-400/20">
                  <SelectValue placeholder="选择报告类型" />
                </SelectTrigger>
                <SelectContent className="border-slate-200 bg-white">
                  <SelectItem value="daily" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">日报</SelectItem>
                  <SelectItem value="weekly" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">周报</SelectItem>
                  <SelectItem value="monthly" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">月报</SelectItem>
                  <SelectItem value="special" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">专项报告</SelectItem>
                </SelectContent>
              </Select>
          </div>
          <div className="space-y-2">
            ...
            <Select value={timeRange} onValueChange={(v) => v && setTimeRange(v)}>
                ...
                <SelectContent className="border-slate-200 bg-white">
                  <SelectItem value="today" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">今日</SelectItem>
                  <SelectItem value="yesterday" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">昨日</SelectItem>
                  <SelectItem value="this_week" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">本周</SelectItem>
                  <SelectItem value="last_week" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">上周</SelectItem>
                  <SelectItem value="this_month" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">本月</SelectItem>
                  <SelectItem value="last_month" className="text-slate-600 focus:bg-cyan-50 focus:text-cyan-700">上月</SelectItem>
                </SelectContent>
              </Select>
          </div>
          <div className="space-y-2">
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">安全运营报告自动生成与管理</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-semibold text-slate-600 flex items-center gap-2">
          ...
          报告列表
          <span className="text-xs text-slate-300 font-normal">({filteredReports.length})</span>
        </h2>
                ...
                <CardContent className="p-5 space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-6 text-[10px] text-slate-300 hover:text-cyan-600 hover:bg-cyan-50 gap-1"
                    >
