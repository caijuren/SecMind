...
export type InvestigationStatus = "investigating" | "pending_review" | "disposing" | "closed"
export type InvestigationTab = InvestigationStatus | "all"
...
export interface DisposalRecommendation {
  category: "containment" | "eradication" | "recovery" | "evidence"
  label: string
  description: string
...
export const TABS: { value: InvestigationTab; labelKey: string; icon: React.ElementType; countKey: keyof TabCounts }[] = [
  { value: "investigating", labelKey: "tabInvestigating", icon: Activity, countKey: "investigating" },
  { value: "pending_review", labelKey: "tabPendingReview", icon: ClipboardList, countKey: "pendingReview" },
  { value: "disposing", labelKey: "tabDisposing", icon: Wrench, countKey: "disposing" },
  { value: "closed", labelKey: "tabClosed", icon: CheckCircle2, countKey: "closed" },
  { value: "all", labelKey: "tabAll", icon: GridIcon, countKey: "total" },
]
...
export const STATUS_CONFIG: Record<InvestigationStatus, { color: string; bg: string; border: string; pulseColor: string; labelKey: string }> = {
  ...
  pending_review: { color: "text-amber-300", bg: "bg-amber-500/10", border: "border-amber-500/20", pulseColor: "bg-amber-400", labelKey: "statusPendingReview" },
  disposing: { color: "text-purple-300", bg: "bg-purple-500/10", border: "border-purple-500/20", pulseColor: "bg-purple-400", labelKey: "statusDisposing" },
  closed: { color: "text-emerald-300", bg: "bg-emerald-500/10", border: "border-emerald-500/20", pulseColor: "bg-emerald-400", labelKey: "statusClosed" },
}

export const STEP_TYPE_CONFIG: Record<AIReasoningStep["type"], { icon: React.ElementType; color: string; labelKey: string }> = {
  discover: { icon: Eye, color: "text-cyan-600", labelKey: "stepTypeDiscover" },
  correlate: { icon: Link2, color: "text-amber-600", labelKey: "stepTypeCorrelate" },
  judge: { icon: Brain, color: "text-[#ff4d4f]", labelKey: "stepTypeJudge" },
}

export const EVIDENCE_TYPE_CONFIG: Record<EvidenceItem["type"], { icon: React.ElementType; labelKey: string; color: string }> = {
  log: { icon: FileText, labelKey: "evidenceTypeLog", color: "#22d3ee" },
  network: { icon: Globe, labelKey: "evidenceTypeNetwork", color: "#a78bfa" },
  endpoint: { icon: Server, labelKey: "evidenceTypeEndpoint", color: "#fbbf24" },
  identity: { icon: User, labelKey: "evidenceTypeIdentity", color: "#34d399" },
  behavioral: { icon: Activity, labelKey: "evidenceTypeBehavioral", color: "#f97316" },
  threat_intel: { icon: Shield, labelKey: "evidenceTypeThreatIntel", color: "#ff4d4f" },
  baseline: { icon: BarChart3, labelKey: "evidenceTypeBaseline", color: "#06b6d4" },
  external: { icon: Globe, labelKey: "evidenceTypeExternal", color: "#64748b" },
}

export const SEVERITY_CONFIG: Record<EvidenceItem["severity"], { color: string; bg: string; labelKey: string }> = {
  critical: { color: "#ff4d4f", bg: "rgba(255,77,79,0.10)", labelKey: "severityCritical" },
  high: { color: "#f97316", bg: "rgba(249,115,22,0.10)", labelKey: "severityHigh" },
  medium: { color: "#fbbf24", bg: "rgba(251,191,36,0.10)", labelKey: "severityMedium" },
  low: { color: "#22d3ee", bg: "rgba(34,211,238,0.10)", labelKey: "severityLow" },
  info: { color: "#6b7280", bg: "rgba(107,114,128,0.10)", labelKey: "severityInfo" },
}

export const DEVIATION_CONFIG: Record<BaselineDeviation["deviationDegree"], { color: string; labelKey: string }> = {
  slight: { color: "#22d3ee", labelKey: "deviationSlight" },
  moderate: { color: "#fbbf24", labelKey: "deviationModerate" },
  severe: { color: "#f97316", labelKey: "deviationSevere" },
  extreme: { color: "#ff4d4f", labelKey: "deviationExtreme" },
}

export const CORRELATION_STRENGTH_CONFIG: Record<CorrelationDetail["strength"], { color: string; labelKey: string }> = {
  weak: { color: "#6b7280", labelKey: "correlationWeak" },
  moderate: { color: "#fbbf24", labelKey: "correlationModerate" },
  strong: { color: "#f97316", labelKey: "correlationStrong" },
  confirmed: { color: "#22c55e", labelKey: "correlationConfirmed" },
}

export const WORK_STATUS_CONFIG: Record<PersonProfile["workStatus"], { color: string; labelKey: string }> = {
  on_duty: { color: "#22c55e", labelKey: "workStatusOnDuty" },
  off_duty: { color: "#6b7280", labelKey: "workStatusOffDuty" },
  vacation: { color: "#3b82f6", labelKey: "workStatusVacation" },
  sick_leave: { color: "#f97316", labelKey: "workStatusSickLeave" },
  business_trip: { color: "#a855f7", labelKey: "workStatusBusinessTrip" },
  remote: { color: "#06b6d4", labelKey: "workStatusRemote" },
}

export const FEEDBACK_TYPE_OPTIONS = [
  { value: "investigation_correct", labelKey: "feedbackInvestigationCorrect" },
  { value: "investigation_wrong", labelKey: "feedbackInvestigationWrong" },
  { value: "judgment_correct", labelKey: "feedbackJudgmentCorrect" },
  { value: "judgment_wrong", labelKey: "feedbackJudgmentWrong" },
  { value: "disposal_effective", labelKey: "feedbackDisposalEffective" },
  { value: "disposal_ineffective", labelKey: "feedbackDisposalIneffective" },
]
...
export const mockRecords: InvestigationRecord[] = [
  {
    id: "INV-2026-0054",
    title: "VPN异常登录调查",
